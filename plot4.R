...
## plot
par(mfrow = c(2,2))
plot(newDateTime, selected_data$Global_active_power, type = "l",xlab = "", ylab = "Global Active Power")
plot(newDateTime, selected_data$Voltage, type = "l",xlab = "datetime", ylab = "Voltage")
...
plot(newDateTime, selected_data$Global_reactive_power, type = "l",xlab = "", ylab = "Global_reactive_power")
